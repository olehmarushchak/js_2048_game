...
parcelHelpers.export(exports, "messageStartLose", ()=>messageStartLose);
"use strict";
const Game = require("789b00406e138236");
const { STATUS_NON_RUN, STATUS_RUN, COUNT_WIN } = require("ea2947bbd40ef054");
const initialState = {
...
const messageStartLose = document.getElementById("message-lose");
...
const appendScore = ()=>{
    game.getScore();
    if (initialState.score === COUNT_WIN) messageWin.classList.remove("hidden");
...
},{"789b00406e138236":"eIbh2","ea2947bbd40ef054":"e0Zqh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eIbh2":[function(require,module,exports) {
/* eslint-disable max-len */ /* eslint-disable no-console */ var _randomAddCellToEmpty = require("../scripts/randomAddCellToEmpty");
// eslint-disable-next-line max-len
var _fillRandomEmptyPlacesStart = require("../scripts/fillRandomEmptyPlacesStart");
var _moveTile = require("../scripts/moveTile");
var _constants = require("./constants");
"use strict";
const { STATUS_RUN } = require("e1248f22bff115f6");
class Game {
    initialState;
    ...
    moveUp() {
        ...
        const { mergeOccurred, tileField: newTileField } = (0, _moveTile.moveTiles)(tileField, size, (0, _constants.Arrow).UP);
        if (mergeOccurred) (0, _moveTile.moveTiles)(newTileField, size, (0, _constants.Arrow).UP); // Compact tiles again after merging
        (0, _randomAddCellToEmpty.fillRandomEmptyPlaces)(this.initialState.tileField);
        console.log(newTileField); // Log the updated tileField after moving up
    }
    moveLeft() {
        const { tileField } = this.initialState;
        const size = tileField.length;
        const { mergeOccurred, tileField: newTileField } = (0, _moveTile.moveTiles)(tileField, size, (0, _constants.Arrow).LEFT);
        if (mergeOccurred) (0, _moveTile.moveTiles)(newTileField, size, (0, _constants.Arrow).LEFT);
        (0, _randomAddCellToEmpty.fillRandomEmptyPlaces)(this.initialState.tileField);
    }
    moveRight() {
        const { tileField } = this.initialState;
        const size = tileField.length;
        const { mergeOccurred, tileField: newTileField } = (0, _moveTile.moveTiles)(tileField, size, (0, _constants.Arrow).RIGHT);
        if (mergeOccurred) (0, _moveTile.moveTiles)(newTileField, size, (0, _constants.Arrow).RIGHT); // Compact tiles again after merging
        (0, _randomAddCellToEmpty.fillRandomEmptyPlaces)(this.initialState.tileField);
    }
    moveDown() {
        const { tileField } = this.initialState;
        const size = tileField.length;
        const { mergeOccurred, tileField: newTileField } = (0, _moveTile.moveTiles)(tileField, size, (0, _constants.Arrow).DOWN);
        if (mergeOccurred) (0, _moveTile.moveTiles)(newTileField, size, (0, _constants.Arrow).DOWN); // Compact tiles again after merging
        (0, _randomAddCellToEmpty.fillRandomEmptyPlaces)(this.initialState.tileField);
    }
    getScore() {
        let score = 0;
    ...
    start() {
        (0, _fillRandomEmptyPlacesStart.fillRandomEmptyPlacesStart)(this.initialState.tileField);
...
},{"../scripts/randomAddCellToEmpty":"4EeJE","../scripts/fillRandomEmptyPlacesStart":"fvcQm","../scripts/moveTile":"5EAid","./constants":"e0Zqh","e1248f22bff115f6":"e0Zqh"}],"4EeJE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getRandomIndexes", ()=>getRandomIndexes);
parcelHelpers.export(exports, "fillRandomEmptyPlaces", ()=>fillRandomEmptyPlaces);
...
function fillRandomEmptyPlaces(field) {
    ...
    if (emptyPositions.length === 0) {
        if (0, _main.messageStartLose) (0, _main.messageStartLose).classList.remove("hidden");
        return field;
    }
...
},{"./main":"3cYfC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}],"fvcQm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fillRandomEmptyPlacesStart", ()=>fillRandomEmptyPlacesStart);
var _randomAddCellToEmpty = require("./randomAddCellToEmpty");
function fillRandomEmptyPlacesStart(field) {
    if (!Array.isArray(field)) {
        // eslint-disable-next-line no-console
        console.error("Expected field to be an array.");
        return field;
    ...
    if (emptyPositions.length >= 2) {
        const randomIndexes = (0, _randomAddCellToEmpty.getRandomIndexes)(emptyPositions.length);
        for(let i = 0; i < 2; i++){
...
},{"./randomAddCellToEmpty":"4EeJE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5EAid":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "moveTiles", ()=>moveTiles);
function moveTiles(tileField, size, direction) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e0Zqh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "STATUS_RUN", ()=>STATUS_RUN);
parcelHelpers.export(exports, "STATUS_NON_RUN", ()=>STATUS_NON_RUN);
parcelHelpers.export(exports, "Arrow", ()=>Arrow);
parcelHelpers.export(exports, "COUNT_WIN", ()=>COUNT_WIN);
const STATUS_RUN = "game run";
const STATUS_NON_RUN = "game is not started";
const Arrow = {
    RIGHT: "right",
    LEFT: "left",
    DOWN: "down",
